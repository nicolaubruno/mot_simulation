...
typedef struct{
    ...
    int state;                  /* Check if the atom is excited or not */
...
scattering_t *photonic_recoil(atom_t atom, beams_setup_t beams_setup, conditions_t conds, environment_t env, double **B);

// Photon absorption
scattering_t photon_absorption(atom_t atom, beams_setup_t beams_setup, conditions_t conds, environment_t env, double **B);
